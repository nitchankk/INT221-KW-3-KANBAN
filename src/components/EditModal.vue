<template>
      ...
      <div class="modal">
        <div class="modal-content">
          ...
          <form @submit.prevent="handleEditTask">
            ...
            <!-- Timezone, Created Date, and Updated Date Display -->
            <div class="details-container">
              <div class="details-group">
                <strong>Timezone:</strong>
                <p class="itbkk-timezone">{{ editedTask.timezone || 'N/A' }}</p>
              </div>
              <div class="details-group">
                <strong>Created Date:</strong>
                <p class="itbkk-created-on">{{ formatLocalDate(editedTask.createdOn) }}</p>
              </div>
              <div class="details-group">
                <strong>Updated Date:</strong>
                <p class="itbkk-updated-on">{{ formatLocalDate(editedTask.updatedOn) }}</p>
              </div>
            </div>
  ...
  const handleEditTask = async () => {
    try {
      ...
      const response = await FetchUtils.putData(`tasks/${props.task.taskId}`, updatedTask);
